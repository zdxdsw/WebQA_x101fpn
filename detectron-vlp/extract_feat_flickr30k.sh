...
DATA_ROOT=/home/yingshac/CYS/WebQnA/RegionFeature/Output
split=00000
...
python ef.py \
    --featcls-output-dir $DATA_ROOT/region_feat/feat_cls_1000 \
    --box-output-dir $DATA_ROOT/region_feat/raw_bbox \
    --output-file-prefix ori_code_detection \
    --max_bboxes 100 --min_bboxes 100 \
    --cfg e2e_faster_rcnn_X-101-64x4d-FPN_2x-vlp.yaml \
    --wts e2e_faster_rcnn_X-101-64x4d-FPN_2x-vlp.pkl \
    --proc_split $split \
    $DATA_ROOT/images \
    | tee log/ori_code_detection_"$split"
